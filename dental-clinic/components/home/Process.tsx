...
const translations = {
  sq: {
    eyebrow: "Procesi ynë",
    title: "Nga vizita e parë deri te",
    highlight: "buzëqeshja finale",
    description:
      "Çdo hap është i organizuar qartë, që trajtimi juaj të jetë i lehtë, i sigurt dhe pa stres.",
    button: "Rezervo Terminin",
  ...
  en: {
    eyebrow: "Our Process",
    title: "From your first visit",
    highlight: "to your final smile",
    description:
      "Every step is carefully planned to ensure your treatment is simple, safe, and stress-free.",
    ...
    steps: [
      {
        number: "01",
        title: "Consultation",
        text: "We listen to your concerns and understand the results you want to achieve.",
      },
      {
        number: "02",
        title: "Diagnosis",
        text: "We perform a dental examination and evaluate your condition to create the right treatment plan.",
      },
      {
        number: "03",
        title: "Treatment Plan",
        text: "We explain each step, the timeline, and the most suitable treatment for you.",
      },
      {
        number: "04",
        title: "Final Treatment",
        text: "We carry out your treatment with care, comfort, and professionalism.",
      },
    ],
  },
};
          ...
          <div className="space-y-6 md:space-y-8">
            {t.steps.map((step) => (
              <div key={step.number} className="relative pl-14 md:pl-16">
                ...
                <div className="mobile-slide-up rounded-[22px] bg-white p-5 shadow-sm transition active:scale-[0.98] md:rounded-[28px] md:p-7 md:hover:-translate-y-1 md:hover:shadow-lg">
                  <h3 className="text-lg font-semibold text-[#052f5e] md:text-xl">
                    {step.title}
                  </h3>
