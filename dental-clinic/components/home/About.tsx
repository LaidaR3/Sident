      ...
      <div className="mx-auto max-w-7xl">
        <div className="grid items-center gap-14 md:grid-cols-[0.95fr_1.05fr] md:gap-16">
          <div className="relative">
            <div className="relative h-[360px] overflow-hidden rounded-[28px] md:h-[560px] md:rounded-[36px]">
              <Image
                src="/images/img2.jpg"
        ...
        Vite përvojë
          ...
          <div className="pt-2 md:pt-0">
            ...
            <div className="mt-7 grid gap-4 sm:grid-cols-2 md:mt-8">
              <div className="rounded-2xl border border-slate-200 bg-[#fbfdfe] p-5 active:scale-[0.98] md:hover:-translate-y-1 md:hover:shadow-lg">
            ...
            <Link
              href="/about"
              className="mt-8 inline-flex rounded-full bg-[#052f5e] px-7 py-3 text-sm font-bold text-white active:scale-95 active:bg-[#00408a] md:mt-10 md:hover:bg-[#00408a]"
            >
              Mëso më shumë
            </Link>
          </div>
