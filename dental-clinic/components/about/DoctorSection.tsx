                    ...
                    {doctors.map((doctor, index) => {
                        ...
                        return (
                            <div
                                ...
                                className={`grid items-center gap-12 ${reverse
                            ...
                            >
                                ...
                                <div className={reverse ? "md:order-1" : ""}>
                                    ...
                                    <Link
                                        href="/doctors"
                                        className="mt-8 inline-flex items-center gap-2 rounded-full border border-[#052f5e] px-6 py-3 text-sm font-medium text-[#052f5e] transition-all duration-300 hover:bg-[#052f5e] hover:text-white"
                                    >
                                        Lexo më shumë
                                        <span>→</span>
                                    </Link>
